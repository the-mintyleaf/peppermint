...
export function makeSeededRng(seed: string) {
  let s = seed
    .split("")
    .reduce((a, c) => (a * 31 + c.charCodeAt(0)) | 0, 0x12345678);
  return () => {
    ...
    >
      {title && (
        <Text
          ...
          fw={600}
          c="dimmed"
          style={{ letterSpacing: "0.06em", marginBottom: 12, fontSize: 10 }}
        >
          {title}
        </Text>
      )}
  ...
  return (
    ...
    >
      <div style={{ flex: 1, minWidth: 0 }}>
        <Text size="xs" c="dimmed" style={{ fontSize: 11, marginBottom: 4 }}>
          {title}
        </Text>
        <div
          style={{
    ...
    <div>
      ...
      >
        {segments.map((s) => (
          <div
            key={s.label}
            style={{ flex: s.value / sum, background: s.color, minWidth: 4 }}
          />
        ))}
      </div>
      <div
  ...
  return (
    ...
    >
      ...
      {(centerLabel || centerSub) && (
        ...
        >
          {centerLabel && (
            <Text fw={700} style={{ fontSize: 15, lineHeight: 1 }}>
              {centerLabel}
            </Text>
          )}
          {centerSub && (
            <Text c="dimmed" style={{ fontSize: 9, marginTop: 2 }}>
              {centerSub}
            </Text>
          )}
        </div>
...
export function ActivityHeatmap({
  ...
  return (
    <div>
      ...
      >
        {cells.map((v, i) => (
          <div
            ...
            style={{
              borderRadius: 2,
              background: palette[Math.min(4, Math.max(0, v))] ?? palette[0],
            }}
          />
        ))}
      </div>
      ...
      >
        <Text style={{ fontSize: 9 }} c="dimmed">
          6 months ago
        </Text>
        <Text style={{ fontSize: 9 }} c="dimmed">
          Today
