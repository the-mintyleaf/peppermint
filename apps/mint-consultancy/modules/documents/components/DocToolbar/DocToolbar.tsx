...
import { Group, ActionIcon, Text, Divider, Button, Tooltip, Badge } from "@zetsel/ui";
...
export function DocToolbar({
  ...
  const displayName = studentFullData?.fullName ?? `Student ${studentId}`;
  ...
  const metaParts = [
    ...
    lastUpdated ? `Updated ${new Date(lastUpdated).toLocaleDateString()}` : null,
  ].filter(Boolean);
