...
const lorInstitutionDefaults: Partial<Record<DocumentType, Partial<LorContent>>> = {
  "lor-janajagriti": {
  ...
  "lor-kcmit": {
    ...
    institution_address: "Post Box No. 19344, Basuki Marg, Old Baneshwor, Kathmandu, Nepal",
    lor_title: "TO WHOM IT MAY CONCERN",
    lor_salutation: "",
  ...
  "lor-monastic": {
    ...
    institution_address: "Mills Area (Sr.), Bhanu Chowk (Jr.), Janakpurdham, Dhanusha, Nepal",
    lor_title: "To Whom It May Concern",
    lor_salutation: "",
  ...
  "lor-om-health": {
    ...
    institution_subname: "A Sister Organization of Om Hospital & Research Centre (P.) Ltd.",
