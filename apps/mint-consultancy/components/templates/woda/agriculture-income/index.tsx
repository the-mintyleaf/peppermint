...
export function TemplateAgricultureIncome() {
  ...
  const formattedIncome = Number(form.values?.annual_income_nrs ?? 0).toLocaleString("en-IN", {
  ...
  return (
    <>
      <Paper p=".6in" className={classes.root} {...configPageProps}>
        ...
        >
          <Text {...propsText} fw={600}>Ref. No.:</Text>
        ...
        >
          <Group gap="4px">
            <Text {...propsText} fw={600}>Dispatch No.:</Text>
          </Group>
          <Group gap="4px">
            <Text {...propsText} fw={600}>Date:</Text>
        ...
        >
          ...
          <b>NRs. {formattedIncome}</b>{" "}
          (In words: <b>{form.values?.annual_income_words}</b>). This
          certification confirms the significance of the agricultural operations
          conducted on this property, contributing substantially to the local
          economy and ensuring a steady income for the family.
        </Text>
