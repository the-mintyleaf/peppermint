...
export const analyticsQueryKeys = {
  ...
  channelPerformance: (period: string) => ["analytics", "channel-performance", period] as const,
  audience: (period: string) => ["analytics", "audience", period] as const,
  sentimentAnalytics: (period: string) => ["analytics", "sentiment-analytics", period] as const,
