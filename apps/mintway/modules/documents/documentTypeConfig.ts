...
import {
  CvStandardForm,
  CvStandardTemplate,
} from "./document-types/student-cv-standard";
import {
  CvExtendedForm,
  CvExtendedTemplate,
...
import {
  WodaFiscalForm,
  WodaFiscalTemplate,
} from "./document-types/woda-fiscal";
import {
  WodaIncomeForm,
  WodaIncomeTemplate,
} from "./document-types/woda-income";
import {
  WodaMigrationForm,
  WodaMigrationTemplate,
} from "./document-types/woda-migration";
import {
  WodaOccupationForm,
  WodaOccupationTemplate,
} from "./document-types/woda-occupation";
import {
  WodaRelationshipForm,
  WodaRelationshipTemplate,
} from "./document-types/woda-relationship";
import {
  WodaSurnameForm,
  WodaSurnameTemplate,
} from "./document-types/woda-surname";
import {
  WodaTaxClearanceForm,
  WodaTaxClearanceTemplate,
} from "./document-types/woda-tax-clearance";
import {
  WodaAgricultureIncomeForm,
  WodaAgricultureIncomeTemplate,
} from "./document-types/woda-agriculture-income";
import {
  WodaAffidavitFinancialForm,
  WodaAffidavitFinancialTemplate,
} from "./document-types/woda-affidavit-financial";
...
import {
  VyasStatementForm,
  VyasStatementTemplate,
} from "./document-types/bank-vyas-statement";
...
const wodaComponents = {
  ...
  "woda-migration": {
    Form: WodaMigrationForm,
    Template: WodaMigrationTemplate,
  },
  "woda-occupation": {
    Form: WodaOccupationForm,
    Template: WodaOccupationTemplate,
  },
  "woda-relationship": {
    Form: WodaRelationshipForm,
    Template: WodaRelationshipTemplate,
  },
  "woda-surname": { Form: WodaSurnameForm, Template: WodaSurnameTemplate },
  "woda-tax-clearance": {
    Form: WodaTaxClearanceForm,
    Template: WodaTaxClearanceTemplate,
  },
  "woda-agriculture-income": {
    Form: WodaAgricultureIncomeForm,
    Template: WodaAgricultureIncomeTemplate,
  },
  "woda-affidavit-financial": {
    Form: WodaAffidavitFinancialForm,
    Template: WodaAffidavitFinancialTemplate,
  },
} as const;

const bankCertificateComponents = {
  bigyalaxmi: {
    Form: BigyalaxmiCertificateForm,
    Template: BigyalaxmiCertificateTemplate,
  },
  birendranagar: {
    Form: BirendranagarCertificateForm,
    Template: BirendranagarCertificateTemplate,
  },
  himchuli: {
    Form: HimchuliCertificateForm,
    Template: HimchuliCertificateTemplate,
  },
  janautthan: {
    Form: JanautthanCertificateForm,
    Template: JanautthanCertificateTemplate,
  },
  karnali: {
    Form: KarnaliCertificateForm,
    Template: KarnaliCertificateTemplate,
  },
  "mata-bageshwori": {
  ...
  narayan: {
    Form: NarayanCertificateForm,
    Template: NarayanCertificateTemplate,
  },
  shahabhagi: {
    Form: ShahabhagiCertificateForm,
    Template: ShahabhagiCertificateTemplate,
  },
  sumnima: {
    Form: SumnimaCertificateForm,
    Template: SumnimaCertificateTemplate,
  },
  tribeni: {
    Form: TribeniCertificateForm,
    Template: TribeniCertificateTemplate,
  },
...
const bankStatementComponents = {
  bigyalaxmi: {
    Form: BigyalaxmiStatementForm,
    Template: BigyalaxmiStatementTemplate,
  },
  birendranagar: {
    Form: BirendranagarStatementForm,
    Template: BirendranagarStatementTemplate,
  },
  himchuli: {
    Form: HimchuliStatementForm,
    Template: HimchuliStatementTemplate,
  },
  janautthan: {
    Form: JanautthanStatementForm,
    Template: JanautthanStatementTemplate,
  },
  karnali: { Form: KarnaliStatementForm, Template: KarnaliStatementTemplate },
  "mata-bageshwori": {
    Form: MataBageshworiStatementForm,
    Template: MataBageshworiStatementTemplate,
  },
  narayan: { Form: NarayanStatementForm, Template: NarayanStatementTemplate },
  shahabhagi: {
    Form: ShahabhagiStatementForm,
    Template: ShahabhagiStatementTemplate,
  },
