 ...
 * a custom submit so grandway field errors (wrong current password, policy/history
 * violations) land on the right input. On success the backend revokes every session.
 */
