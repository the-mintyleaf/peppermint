...
**Endpoint base:** `/api/v1/applicants/<applicant_id>/addresses/` (detail under
...
| `country`           | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤100 chars | `""` when unset                        |
| `province_or_state` | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤120 chars |                                        |
| `district`          | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤120 chars |                                        |
| `municipality`      | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤120 chars |                                        |
| `ward`              | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤32 chars  |                                        |
| `locality`          | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤150 chars |                                        |
| `street`            | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤200 chars |                                        |
| `postal_code`       | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | ≤32 chars  |                                        |
| `address_text`      | `string`         | ✓      | ✓      | ✗   | No       | ✗          | —              | text       | Free-text fallback when unstructured   |
