...
**Endpoint base:** `/api/v1/documents/<document_id>/print-events/` (detail under
`.../print-events/<print_event_id>/`).
...
{
  "revision_number": 3,
  "content_snapshot": { /* what was rendered */ },
  "derived_values_snapshot": { "closing_balance": "500000.00", "amount_in_words": "Five Hundred Thousand" },
