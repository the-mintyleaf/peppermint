...
| Section     | Path                    | Notes                                                                                                                                                                                                                                        |
| ----------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Applicants  | `applicant/applicants`  | `/admin/applicants` list (staff/admin projections, tabs, dup warning) + `[id]` overview + create/edit + inline Stage/Engagement switches (`ApplicantLifecycleSwitch`, admin-only, open the transition modal pre-filled) + lock/archive/merge |
