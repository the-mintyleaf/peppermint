...
/**
 * The shared status-switch trigger — a pale, status-colored pill (dot + label + caret)
 * used as a `Menu.Target`. One source of truth for the look across the users, signatures,
 * and applicant lifecycle switches. Forwards its ref and the props `Menu.Target` injects
 * so the dropdown wires up correctly.
 */
