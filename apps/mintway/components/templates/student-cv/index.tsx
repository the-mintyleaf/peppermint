          ...
          <Box>
            ...
            <Stack gap="xs" mt="sm">
              ...
              <Group gap="sm" wrap="nowrap" align="flex-start">
                ...
                <Text size="xs" c="white" style={{ flex: 1 }}>
                  {d.current_address || "——"}
                </Text>
              </Group>
            </Stack>
          ...
          <Box>
            ...
            <Stack gap="xs" mt="sm">
              ...
              <Group gap="sm" wrap="nowrap">
                ...
                <Text size="xs" c="white" style={{ wordBreak: "break-all" }}>
                  {d.email || "——"}
                </Text>
              </Group>
            </Stack>
          ...
          <Box>
            ...
            <Stack gap={2} mt="sm">
              <Text size="sm" fw={600} c="white">
                {d.contact_detail?.emergency_contact_name || "——"}
              </Text>
              <Text size="xs" c="gray.3">
                {d.contact_detail?.emergency_contact_relation || "Relation"}
              </Text>
              <Text size="xs" mt={4} c="white">
                T: {d.contact_detail?.emergency_contact_phone || "——"}
              </Text>
            </Stack>
          </Box>
        ...
        {d.experiences && d.experiences.length > 0 && (
          <Box mb="xl">
            <Text
              size="lg"
              fw={600}
              style={{ borderBottom: "1px solid #ddd", paddingBottom: 4 }}
              mb="md"
            >
              Work Experience
            </Text>
        ...
        {d.gradings && d.gradings.length > 0 && (
          <Box mb="xl">
            ...
            <Flex wrap="wrap" gap="lg">
              <Box w="45%">
                <Text size="xs" mb={4}>
                  Grammar - {d.gradings[0].grammar}
                </Text>
                <Progress
                  value={gradeToPercent(d.gradings[0].grammar)}
                  color="#5D5D5D"
                  size="sm"
                />
              </Box>
              <Box w="45%">
                <Text size="xs" mb={4}>
                  Conversation - {d.gradings[0].conversation}
                </Text>
                <Progress
                  value={gradeToPercent(d.gradings[0].conversation)}
                  color="#5D5D5D"
                  size="sm"
                />
              </Box>
              <Box w="45%">
                <Text size="xs" mb={4}>
                  Listening - {d.gradings[0].listening}
                </Text>
                <Progress
                  value={gradeToPercent(d.gradings[0].listening)}
                  color="#5D5D5D"
                  size="sm"
                />
              </Box>
              <Box w="45%">
                <Text size="xs" mb={4}>
                  Reading - {d.gradings[0].reading}
                </Text>
                <Progress
                  value={gradeToPercent(d.gradings[0].reading)}
                  color="#5D5D5D"
                  size="sm"
                />
              </Box>
              <Box w="45%">
                <Text size="xs" mb={4}>
                  Composition - {d.gradings[0].composition}
                </Text>
                <Progress
                  value={gradeToPercent(d.gradings[0].composition)}
                  color="#5D5D5D"
                  size="sm"
                />
              </Box>
