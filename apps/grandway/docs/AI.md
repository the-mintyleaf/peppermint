...
| Applicant Journeys       | `modules/admin/applicant-journeys`            | `/admin/applicant-journeys`, `/admin/applicant-journeys/[id]`                                                                                        | `MultiPageModule`, `admin`/`lead_manager` only (`RequireLeadAccess`, identical rule to Leads/Applicants). `ModalTableShell` worklist (stage/target-country column filters, no category tabs) + modal create/edit + dedicated Journey Detail route (linkable permalink, per the concept doc) + 3 lifecycle dialogs (defer/close/reopen — plain stage moves confirm inline in `JourneyStageSwitch`). No delete                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
