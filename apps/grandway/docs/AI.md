...
└── modules/
    ...
    └── admin/
        ...
        └── dashboard/        # Not-Contained (reporting) — IS the /admin home; 8 independent read-only sections behind an Overview + 6 detail tabs, no CRUD
            ...
            └── components/{SuperadminLanding,DashboardHero,DashboardHeaderControls,DashboardTabs,OverviewPanel,NeedsAttention,TodayWorklists,PipelineCounts,Blockers,Workload,Conversion,Outcomes,ActivityFeed}.tsx  # charts via @peppermint/ui/charts (DonutStat, CategoryBarChart, StackedBarChart, Gauge)
```
