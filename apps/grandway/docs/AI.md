...
└── modules/
    ...
    └── admin/
        ...
        │       └── detail/               # Journey Detail — 2-col ProfileLayout: sticky Overview sidebar (destination + objective facts + Change-stage/Defer/Close/Reopen) | underline tabs Worklist / Files / History
