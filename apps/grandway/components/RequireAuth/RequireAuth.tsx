 ...
 * (superadmin/admin/lead_manager). Unlike `RequireStaff` (which requires the admin
 * baseline), this only guards against an unverifiable session — object-level authority
 * rules live in each section.
 */
