...
/**
 * Whole-set-replace on submit, matching the backend contract — the array
 * this manages IS the payload, not a delta. Exactly one row is primary at
 * all times once the list is non-empty; the backend doesn't hard-require
 * this, but it's the only sane UI default, so the radio group enforces it
 * client-side rather than leaving zero-or-many primaries reachable.
 */
