...
import { createLorForm } from "../../utils/sharedForms";

export const LorJanajagriti = createLorForm({
...
export const LorShiva = createLorForm({
...
export const LorOmHealth = createLorForm({
