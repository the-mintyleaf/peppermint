...
import { Stack, Button, Text, TextInput, Textarea } from "@peppermint/ui";
...
export function CvExtendedForm({
  applicantId,
  studentFullData,
  onSubmit,
  isLoading,
    ...
    <form onSubmit={form.onSubmit(handleSubmit)}>
      <Stack gap="md" p="md">
        ...
        <Textarea
          ...
          placeholder={
            "Hospital Preparedness for Emergencies (HOPE) course\nTraining on Infection control and prevention"
          }
          autosize
          minRows={3}
        ...
        <TextInput
          label="Name"
          {...form.getInputProps("ref1_name")}
          disabled={isLoading}
        />
        <TextInput
          label="Title / Position"
          {...form.getInputProps("ref1_title")}
          disabled={isLoading}
        />
        <TextInput
          label="Institution"
          {...form.getInputProps("ref1_institution")}
          disabled={isLoading}
        />
        <TextInput
          label="Address"
          {...form.getInputProps("ref1_address")}
          disabled={isLoading}
        />
        <TextInput
          label="Email"
          {...form.getInputProps("ref1_email")}
          disabled={isLoading}
        />
        <TextInput
          label="Contact Number"
          {...form.getInputProps("ref1_contact")}
          disabled={isLoading}
        />
        ...
        <TextInput
          label="Name"
          {...form.getInputProps("ref2_name")}
          disabled={isLoading}
        />
        <TextInput
          label="Title / Position"
          {...form.getInputProps("ref2_title")}
          disabled={isLoading}
        />
        <TextInput
          label="Institution"
          {...form.getInputProps("ref2_institution")}
          disabled={isLoading}
        />
        <TextInput
          label="Address"
          {...form.getInputProps("ref2_address")}
          disabled={isLoading}
        />
        <TextInput
          label="Email"
          {...form.getInputProps("ref2_email")}
          disabled={isLoading}
        />
        <TextInput
          label="Contact Number"
          {...form.getInputProps("ref2_contact")}
          disabled={isLoading}
        />
